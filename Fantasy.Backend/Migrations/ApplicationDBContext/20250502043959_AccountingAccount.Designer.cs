...
namespace Fantasy.Backend.Migrations.ApplicationDBContext
{
    ...
    [Migration("20250502043959_AccountingAccount")]
    partial class AccountingAccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YourNamespace.Models.AccountingAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YourNamespace.Models.AccountingAccount", b =>
                {
                    b.HasOne("YourNamespace.Models.AccountingAccount", "ParentAccount")
                        .WithMany()
